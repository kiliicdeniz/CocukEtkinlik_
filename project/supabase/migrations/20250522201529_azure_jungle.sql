/*
  ...
  1. Changes
    - Insert initial set of games with activities and crafts
    - Each game includes full details including materials and instructions
    - All games are associated with a system user
  
  2. Security
    - Uses a fixed system user ID for initial data
*/

DO $$
BEGIN
  -- Insert activities with a fixed system user ID
  INSERT INTO games (
