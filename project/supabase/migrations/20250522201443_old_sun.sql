/*
  ...
  This migration inserts the initial set of activities into the games table.
  
  1. Data Changes
    - Inserts 12 activities with complete details including:
      - Title, description, category
      - Age ranges and materials
      - Instructions and difficulty levels
      - Time requirements and featured status
  
  2. Notes
    - All activities are associated with a system user for initial seeding
    - Featured activities are marked accordingly
*/
...
DECLARE
  system_user_id UUID;
BEGIN
  -- Get or create system user ID (you should replace this with actual admin user ID)
